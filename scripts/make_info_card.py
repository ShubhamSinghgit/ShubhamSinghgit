...
# ===========================================================================
HOST = "ShubhamSinghgit"   # shown as shubhamsinghgit@github in the header

ROWS = [
    ("host",),
    ("kv", "Role", "Full Stack Developer & Freelancer"),
    ("kv", "Edu", "Computer Science Graduate"),
    ("kv", "Also", "Agentic AI Tinkerer & Tech Speaker"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Frontend", "React, Next.js, TypeScript"),
    ("kv", "Backend", "Node.js, Python, GraphQL, FastAPI"),
    ("kv", "AI / ML", "LLMs, RAG, agent workflows"),
    ("kv", "Cloud", "Docker, GitHub Actions, Vercel"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Contributed to open-source and frontend tooling"),
    ("bul", "Built dev-focused projects and AI workflows"),
    ("bul", "Mentor for community and hackathon work"),
    ("bul", "Contact: hello@workwithshubham.me"),
]
